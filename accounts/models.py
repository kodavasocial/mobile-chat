...
class User(AbstractUser):
    ...
    gender = models.CharField(
        max_length=6, choices=GENDER, null=True, blank=True)
    ...
    weight = models.PositiveIntegerField(
        null=True, blank=True, help_text="Weight in KG")
    education = models.CharField(max_length=100, null=True, blank=True)
    occupation = models.CharField(max_length=100, null=True, blank=True)
    income = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True, help_text="Income in Rs.")
    family_status = models.CharField(max_length=100, null=True, blank=True)
    alcoholic = models.CharField(
        max_length=6, choices=ALCOHOLIC, null=True, blank=True, default="No")
    smoker = models.CharField(
        max_length=6, choices=SMOKER, null=True, blank=True, default="No")
